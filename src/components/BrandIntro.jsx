    ...
    <section className="relative bg-ivory-50 text-ink-800 py-32 md:py-48">
      <div className="mx-auto max-w-9xl px-6 md:px-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16">
          <h2 className="lg:col-span-8 font-serif font-light text-display-lg text-ink-800 reveal text-balance leading-[1.02]"
              data-delay="1">
          ...
          <div className="lg:col-span-4 lg:pt-4 reveal" data-delay="3">
            <p className="font-sans font-light text-base md:text-lg leading-relaxed text-ink-700 max-w-md">
              At Heaven Furniture Mart, furniture is more than function. Every piece is designed
              around the people, spaces and lifestyles it belongs to — then crafted with care in
              Chattogram.
            </p>
